...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <ol class="flex items-center gap-2">
            ...
            <li class="font-medium text-primary add-heading">Edit Boat</li>
        </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
   ...
   <div class="bg-white rounded-md shadow-md border border-stroke p-6 dark:bg-boxdark dark:border-strokedark">
    <form action="{{ route('customer_boats.update', $customerBoat->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input
                    ...
                    id="name"
                    name="name"
                    value="{{ old('name', $customerBoat->name) }}"
            ...
            <div>
                ...
                >
                    ...
                    @foreach ($users as $user)
                        <option value="{{ $user->id }}"  {{ old('user_id', $customerBoat->user_id) == $user->id ? 'selected' : '' }}>
                            {{ $user->name }}
                        </option>
                    @endforeach
                </select>
