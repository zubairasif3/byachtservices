    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="font-medium text-primary add-heading">Create Invoice</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select id="customer_id" name="customer_id" class="w-full rounded border border-gray-300 px-4 py-2" disabled>
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{ $customer->id }}" data-previous-blance="{{ $customer->customer_runing_balance() }}">{{ $customer->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="invoice_no" name="invoice_no"
                            class="w-full rounded border border-gray-300 px-4 py-2" required>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="invoice_amount" name="invoice_amount"
                                class="w-full rounded border border-gray-300 px-4 py-2" readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="paid_amount" name="paid_amount"
                                class="w-full rounded border border-gray-300 px-4 py-2" value="0">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        <div>
                            ...
                            <input type="number" id="customer_variable" name="customer_variable"
                                class="w-full rounded border border-gray-300 px-4 py-2" value="1.0">
                        </div>
